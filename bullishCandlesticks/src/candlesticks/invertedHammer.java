...
/*
 * This is a similar candlestick to the hammer candlestick.
 * This candlestick is just inverted, so the numbers are the same,
 * thae candlestick is just upside down, both signal a 
 * bullish reversal
 */

public class invertedHammer {
	
	private static final double DAY_CHANGE = 3.5; //%
	private static final double OPEN_LOW_MIN = 0.0; //%
	private static final double OPEN_LOW_MAX = 0.9; //%
	private static final double HIGH_CLOSE_MIN = 6.0; //%
	private static final double HIGH_CLOSE_MAX = 14.0; //%
